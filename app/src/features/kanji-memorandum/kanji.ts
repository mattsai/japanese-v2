...
export const n5KanjiMemorandum: KanjiMemorandumItem[] = [
  ...
  k("kanji-mai", "毎", "cada", "every", ["マイ"], [], [{ word: "毎日", reading: "まいにち", meaningEs: "todos los dias" }], "Aparece en 毎日, 毎週, 毎朝: indica 'cada'.", 6),
  k("kanji-ten", "天", "cielo", "heaven; sky", ["テン"], [], [{ word: "天気", reading: "てんき", meaningEs: "clima" }], "Aparece en 天気 (clima). Idea de cielo.", 4),
